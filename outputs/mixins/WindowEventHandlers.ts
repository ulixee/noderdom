...
export default function WindowEventHandlers<TBase extends Constructor>(base: TBase) {
  return class extends base implements IWindowEventHandlers {
    public get onafterprint(): ((this: IWindowEventHandlers, ev: IEvent) => any) | null {
      return InternalHandler.get<IWindowEventHandlers, ((this: IWindowEventHandlers, ev: IEvent) => any) | null>(
        this,
        'onafterprint',
      );
    }
    ...
    public set onafterprint(value: ((this: IWindowEventHandlers, ev: IEvent) => any) | null) {
      InternalHandler.set<IWindowEventHandlers, ((this: IWindowEventHandlers, ev: IEvent) => any) | null>(
        this,
        'onafterprint',
        value,
      );
    ...
    public addEventListener<K extends keyof IWindowEventHandlersEventMap>(
      type: K,
      listener: (this: IWindowEventHandlers, ev: IWindowEventHandlersEventMap[K]) => any,
    ...
    public removeEventListener<K extends keyof IWindowEventHandlersEventMap>(
      type: K,
      listener: (this: IWindowEventHandlers, ev: IWindowEventHandlersEventMap[K]) => any,
...
export const rpWindowEventHandlersKeys: Set<string> = new Set([]);

export interface IWindowEventHandlersRps {}
