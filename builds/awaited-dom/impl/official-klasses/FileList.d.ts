...
export declare const getState: (instance: IFileList) => IFileListProperties, setState: (instance: IFileList, properties: Partial<IFileListProperties>) => void, recordProxy: (proxy: IFileList, instance: IFileList) => void;
