...
export declare const getState: (instance: ITextTrackCueList) => ITextTrackCueListProperties, setState: (instance: ITextTrackCueList, properties: Partial<ITextTrackCueListProperties>) => void, recordProxy: (proxy: ITextTrackCueList, instance: ITextTrackCueList) => void;
