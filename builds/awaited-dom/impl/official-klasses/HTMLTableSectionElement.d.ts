...
import { IHTMLTableSectionElementProperties } from '../../base/official-klasses/HTMLTableSectionElement';
...
declare const HTMLTableSectionElementBaseClass: {
    new (): {
