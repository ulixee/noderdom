...
export declare const getState: (instance: IHTMLUListElementIsolate) => IHTMLUListElementIsolateProperties, setState: (instance: IHTMLUListElementIsolate, properties: Partial<IHTMLUListElementIsolateProperties>) => void, recordProxy: (proxy: IHTMLUListElementIsolate, instance: IHTMLUListElementIsolate) => void;
