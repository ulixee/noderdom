...
export declare const getState: (instance: IHTMLBaseElementIsolate) => IHTMLBaseElementIsolateProperties, setState: (instance: IHTMLBaseElementIsolate, properties: Partial<IHTMLBaseElementIsolateProperties>) => void, recordProxy: (proxy: IHTMLBaseElementIsolate, instance: IHTMLBaseElementIsolate) => void;
