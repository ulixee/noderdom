...
export declare const getState: (instance: IHTMLDataElementIsolate) => IHTMLDataElementIsolateProperties, setState: (instance: IHTMLDataElementIsolate, properties: Partial<IHTMLDataElementIsolateProperties>) => void, recordProxy: (proxy: IHTMLDataElementIsolate, instance: IHTMLDataElementIsolate) => void;
