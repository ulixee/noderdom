...
export declare const getState: (instance: IHTMLDocumentIsolate) => IHTMLDocumentIsolateProperties, setState: (instance: IHTMLDocumentIsolate, properties: Partial<IHTMLDocumentIsolateProperties>) => void, recordProxy: (proxy: IHTMLDocumentIsolate, instance: IHTMLDocumentIsolate) => void;
