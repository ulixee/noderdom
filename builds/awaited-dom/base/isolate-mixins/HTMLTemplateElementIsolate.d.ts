...
export declare const getState: (instance: IHTMLTemplateElementIsolate) => IHTMLTemplateElementIsolateProperties, setState: (instance: IHTMLTemplateElementIsolate, properties: Partial<IHTMLTemplateElementIsolateProperties>) => void, recordProxy: (proxy: IHTMLTemplateElementIsolate, instance: IHTMLTemplateElementIsolate) => void;
