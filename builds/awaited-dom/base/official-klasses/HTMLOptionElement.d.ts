...
export declare const getState: <C = IHTMLOptionElement, P = IHTMLOptionElementProperties>(instance: C) => P, setState: <P = IHTMLOptionElementProperties>(instance: IHTMLOptionElement, properties: P) => void;
...
export declare function HTMLOptionElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLOptionElement, TResult2 = never>(onfulfilled?: ((value: IHTMLOptionElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLOptionElementPropertyKeys: string[];
export declare const HTMLOptionElementConstantKeys: string[];
