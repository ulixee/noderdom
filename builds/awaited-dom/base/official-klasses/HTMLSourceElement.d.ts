...
export declare const awaitedHandler: AwaitedHandler<IHTMLSourceElement>;
export declare const nodeFactory: NodeFactory<IHTMLSourceElement>;
export declare function HTMLSourceElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLSourceElement, TResult2 = never>(onfulfilled?: ((value: IHTMLSourceElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLSourceElementPropertyKeys: string[];
export declare const HTMLSourceElementConstantKeys: string[];
