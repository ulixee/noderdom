...
export declare const getState: (instance: IHTMLHtmlElement) => IHTMLHtmlElementProperties, setState: (instance: IHTMLHtmlElement, properties: Partial<IHTMLHtmlElementProperties>) => void;
