...
export declare const getState: (instance: IHTMLLabelElement) => IHTMLLabelElementProperties, setState: (instance: IHTMLLabelElement, properties: Partial<IHTMLLabelElementProperties>) => void;
...
export declare function HTMLLabelElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLLabelElement, TResult2 = never>(onfulfilled?: ((value: IHTMLLabelElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLLabelElementPropertyKeys: string[];
export declare const HTMLLabelElementConstantKeys: string[];
