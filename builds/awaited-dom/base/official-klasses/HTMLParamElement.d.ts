...
export declare const awaitedHandler: AwaitedHandler<IHTMLParamElement>;
export declare const nodeFactory: NodeFactory<IHTMLParamElement>;
export declare function HTMLParamElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly name: Promise<string>;
        readonly type: Promise<string>;
        readonly value: Promise<string>;
        readonly valueType: Promise<string>;
        then<TResult1 = IHTMLParamElement, TResult2 = never>(onfulfilled?: ((value: IHTMLParamElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLParamElementPropertyKeys: string[];
export declare const HTMLParamElementConstantKeys: string[];
