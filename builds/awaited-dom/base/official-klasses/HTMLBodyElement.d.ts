...
export declare const awaitedHandler: AwaitedHandler<IHTMLBodyElement>;
export declare const nodeFactory: NodeFactory<IHTMLBodyElement>;
export declare function HTMLBodyElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLBodyElement, TResult2 = never>(onfulfilled?: ((value: IHTMLBodyElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLBodyElementPropertyKeys: string[];
export declare const HTMLBodyElementConstantKeys: string[];
