...
export declare function HTMLLinkElementGenerator(HTMLElement: Constructable<IHTMLElement>, LinkStyle: Constructable<ILinkStyle>): {
    new (): {
        ...
        then<TResult1 = IHTMLLinkElement, TResult2 = never>(onfulfilled?: ((value: IHTMLLinkElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLLinkElementPropertyKeys: string[];
export declare const HTMLLinkElementConstantKeys: string[];
