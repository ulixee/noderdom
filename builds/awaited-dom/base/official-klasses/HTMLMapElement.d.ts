...
export declare function HTMLMapElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLMapElement, TResult2 = never>(onfulfilled?: ((value: IHTMLMapElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLMapElementPropertyKeys: string[];
export declare const HTMLMapElementConstantKeys: string[];
