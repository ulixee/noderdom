...
export declare const awaitedHandler: AwaitedHandler<IHTMLModElement>;
export declare const nodeFactory: NodeFactory<IHTMLModElement>;
export declare function HTMLModElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly cite: Promise<string>;
        readonly dateTime: Promise<string>;
        then<TResult1 = IHTMLModElement, TResult2 = never>(onfulfilled?: ((value: IHTMLModElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLModElementPropertyKeys: string[];
export declare const HTMLModElementConstantKeys: string[];
