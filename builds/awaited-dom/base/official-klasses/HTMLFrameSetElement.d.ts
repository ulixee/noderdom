...
export declare function HTMLFrameSetElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLFrameSetElement, TResult2 = never>(onfulfilled?: ((value: IHTMLFrameSetElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLFrameSetElementPropertyKeys: string[];
export declare const HTMLFrameSetElementConstantKeys: string[];
