...
export declare const awaitedHandler: AwaitedHandler<IHTMLTitleElement>;
export declare const nodeFactory: NodeFactory<IHTMLTitleElement>;
export declare function HTMLTitleElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly text: Promise<string>;
        then<TResult1 = IHTMLTitleElement, TResult2 = never>(onfulfilled?: ((value: IHTMLTitleElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLTitleElementPropertyKeys: string[];
export declare const HTMLTitleElementConstantKeys: string[];
