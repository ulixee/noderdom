...
export declare function HTMLDataListElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLDataListElement, TResult2 = never>(onfulfilled?: ((value: IHTMLDataListElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLDataListElementPropertyKeys: string[];
export declare const HTMLDataListElementConstantKeys: string[];
