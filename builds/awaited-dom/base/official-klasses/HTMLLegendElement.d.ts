...
export declare function HTMLLegendElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLLegendElement, TResult2 = never>(onfulfilled?: ((value: IHTMLLegendElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLLegendElementPropertyKeys: string[];
export declare const HTMLLegendElementConstantKeys: string[];
