...
export declare function HTMLFontElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLFontElement, TResult2 = never>(onfulfilled?: ((value: IHTMLFontElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLFontElementPropertyKeys: string[];
export declare const HTMLFontElementConstantKeys: string[];
