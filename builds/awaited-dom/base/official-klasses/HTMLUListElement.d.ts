...
export declare const getState: (instance: IHTMLUListElement) => IHTMLUListElementProperties, setState: (instance: IHTMLUListElement, properties: Partial<IHTMLUListElementProperties>) => void;
