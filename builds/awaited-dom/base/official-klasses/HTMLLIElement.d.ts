...
export declare function HTMLLIElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLLIElement, TResult2 = never>(onfulfilled?: ((value: IHTMLLIElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLLIElementPropertyKeys: string[];
export declare const HTMLLIElementConstantKeys: string[];
