...
export declare const awaitedHandler: AwaitedHandler<IHTMLDetailsElement>;
export declare const nodeFactory: NodeFactory<IHTMLDetailsElement>;
export declare function HTMLDetailsElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly open: Promise<boolean>;
        then<TResult1 = IHTMLDetailsElement, TResult2 = never>(onfulfilled?: ((value: IHTMLDetailsElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLDetailsElementPropertyKeys: string[];
export declare const HTMLDetailsElementConstantKeys: string[];
