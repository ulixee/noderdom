...
exports.DocumentConstantKeys = exports.DocumentPropertyKeys = exports.DocumentGenerator = exports.nodeAttacher = exports.awaitedHandler = exports.recordProxy = exports.setState = exports.getState = void 0;
...
function DocumentGenerator(Node, DocumentOrShadowRoot, FontFaceSource, NonElementParentNode, ParentNode, XPathEvaluatorBase) {
    const Parent = ClassMixer_1.default(Node, [DocumentOrShadowRoot, FontFaceSource, NonElementParentNode, ParentNode, XPathEvaluatorBase]);
...
exports.DocumentPropertyKeys = [...Node_1.NodePropertyKeys, ...DocumentOrShadowRoot_1.DocumentOrShadowRootPropertyKeys, ...FontFaceSource_1.FontFaceSourcePropertyKeys, ...NonElementParentNode_1.NonElementParentNodePropertyKeys, ...ParentNode_1.ParentNodePropertyKeys, ...XPathEvaluatorBase_1.XPathEvaluatorBasePropertyKeys, 'URL', 'anchors', 'body', 'characterSet', 'compatMode', 'contentType', 'cookie', 'designMode', 'dir', 'doctype', 'documentElement', 'documentURI', 'domain', 'embeds', 'featurePolicy', 'forms', 'fullscreenEnabled', 'head', 'hidden', 'images', 'implementation', 'lastModified', 'links', 'location', 'plugins', 'readyState', 'referrer', 'scripts', 'scrollingElement', 'title', 'visibilityState'];
exports.DocumentConstantKeys = [...Node_1.NodeConstantKeys, ...DocumentOrShadowRoot_1.DocumentOrShadowRootConstantKeys, ...FontFaceSource_1.FontFaceSourceConstantKeys, ...NonElementParentNode_1.NonElementParentNodeConstantKeys, ...ParentNode_1.ParentNodeConstantKeys, ...XPathEvaluatorBase_1.XPathEvaluatorBaseConstantKeys];
