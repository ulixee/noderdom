...
export declare const getState: (instance: IVideoTrackList) => IVideoTrackListProperties, setState: (instance: IVideoTrackList, properties: Partial<IVideoTrackListProperties>) => void, recordProxy: (proxy: IVideoTrackList, instance: IVideoTrackList) => void;
