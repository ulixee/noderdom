...
export declare const awaitedHandler: AwaitedHandler<IHTMLMetaElement>;
export declare const nodeFactory: NodeFactory<IHTMLMetaElement>;
export declare function HTMLMetaElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly content: Promise<string>;
        readonly httpEquiv: Promise<string>;
        readonly name: Promise<string>;
        readonly scheme: Promise<string>;
        then<TResult1 = IHTMLMetaElement, TResult2 = never>(onfulfilled?: ((value: IHTMLMetaElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLMetaElementPropertyKeys: string[];
export declare const HTMLMetaElementConstantKeys: string[];
