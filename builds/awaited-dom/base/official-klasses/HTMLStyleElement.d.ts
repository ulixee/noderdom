...
export declare const awaitedHandler: AwaitedHandler<IHTMLStyleElement>;
export declare const nodeFactory: NodeFactory<IHTMLStyleElement>;
export declare function HTMLStyleElementGenerator(HTMLElement: Constructable<IHTMLElement>, LinkStyle: Constructable<ILinkStyle>): {
    new (): {
        readonly media: Promise<string>;
        readonly type: Promise<string>;
        then<TResult1 = IHTMLStyleElement, TResult2 = never>(onfulfilled?: ((value: IHTMLStyleElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLStyleElementPropertyKeys: string[];
export declare const HTMLStyleElementConstantKeys: string[];
