...
export declare function HTMLSlotElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        getRootNode(options?: import("../interfaces/official").IGetRootNodeOptions | undefined): ISuperNode;
...
export declare const HTMLSlotElementPropertyKeys: string[];
export declare const HTMLSlotElementConstantKeys: string[];
