...
exports.HTMLObjectElementConstantKeys = exports.HTMLObjectElementPropertyKeys = exports.HTMLObjectElementGenerator = exports.nodeFactory = exports.awaitedHandler = exports.recordProxy = exports.setState = exports.getState = void 0;
...
function HTMLObjectElementGenerator(HTMLElement) {
    return class HTMLObjectElement extends HTMLElement {
        constructor() {
            super();
            initializeConstantsAndProperties_1.default(this, exports.HTMLObjectElementConstantKeys, exports.HTMLObjectElementPropertyKeys);
