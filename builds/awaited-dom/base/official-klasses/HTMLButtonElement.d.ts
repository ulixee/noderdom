...
export declare function HTMLButtonElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLButtonElement, TResult2 = never>(onfulfilled?: ((value: IHTMLButtonElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLButtonElementPropertyKeys: string[];
export declare const HTMLButtonElementConstantKeys: string[];
