...
export declare const awaitedHandler: AwaitedHandler<IHTMLBaseElement>;
export declare const nodeFactory: NodeFactory<IHTMLBaseElement>;
export declare function HTMLBaseElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly href: Promise<string>;
        readonly target: Promise<string>;
        then<TResult1 = IHTMLBaseElement, TResult2 = never>(onfulfilled?: ((value: IHTMLBaseElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLBaseElementPropertyKeys: string[];
export declare const HTMLBaseElementConstantKeys: string[];
