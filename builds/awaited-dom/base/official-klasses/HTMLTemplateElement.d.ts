...
export declare const awaitedHandler: AwaitedHandler<IHTMLTemplateElement>;
export declare const nodeFactory: NodeFactory<IHTMLTemplateElement>;
export declare function HTMLTemplateElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly content: IDocumentFragment;
        then<TResult1 = IHTMLTemplateElement, TResult2 = never>(onfulfilled?: ((value: IHTMLTemplateElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLTemplateElementPropertyKeys: string[];
export declare const HTMLTemplateElementConstantKeys: string[];
