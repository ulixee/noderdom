...
export declare function HTMLDirectoryElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLDirectoryElement, TResult2 = never>(onfulfilled?: ((value: IHTMLDirectoryElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLDirectoryElementPropertyKeys: string[];
export declare const HTMLDirectoryElementConstantKeys: string[];
