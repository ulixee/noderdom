...
export declare function HTMLAreaElementGenerator(HTMLElement: Constructable<IHTMLElement>, HTMLHyperlinkElementUtils: Constructable<IHTMLHyperlinkElementUtils>): {
    new (): {
        ...
        then<TResult1 = IHTMLAreaElement, TResult2 = never>(onfulfilled?: ((value: IHTMLAreaElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLAreaElementPropertyKeys: string[];
export declare const HTMLAreaElementConstantKeys: string[];
