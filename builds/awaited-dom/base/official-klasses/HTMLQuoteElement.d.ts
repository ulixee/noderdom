...
export declare function HTMLQuoteElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLQuoteElement, TResult2 = never>(onfulfilled?: ((value: IHTMLQuoteElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLQuoteElementPropertyKeys: string[];
export declare const HTMLQuoteElementConstantKeys: string[];
