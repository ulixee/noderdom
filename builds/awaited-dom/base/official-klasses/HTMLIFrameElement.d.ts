...
export declare function HTMLIFrameElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLIFrameElement, TResult2 = never>(onfulfilled?: ((value: IHTMLIFrameElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLIFrameElementPropertyKeys: string[];
export declare const HTMLIFrameElementConstantKeys: string[];
