...
export declare function HTMLEmbedElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLEmbedElement, TResult2 = never>(onfulfilled?: ((value: IHTMLEmbedElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLEmbedElementPropertyKeys: string[];
export declare const HTMLEmbedElementConstantKeys: string[];
