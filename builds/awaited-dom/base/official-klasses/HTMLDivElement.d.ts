...
export declare const awaitedHandler: AwaitedHandler<IHTMLDivElement>;
export declare const nodeFactory: NodeFactory<IHTMLDivElement>;
export declare function HTMLDivElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly align: Promise<string>;
        then<TResult1 = IHTMLDivElement, TResult2 = never>(onfulfilled?: ((value: IHTMLDivElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLDivElementPropertyKeys: string[];
export declare const HTMLDivElementConstantKeys: string[];
