...
export declare function HTMLProgressElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLProgressElement, TResult2 = never>(onfulfilled?: ((value: IHTMLProgressElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLProgressElementPropertyKeys: string[];
export declare const HTMLProgressElementConstantKeys: string[];
