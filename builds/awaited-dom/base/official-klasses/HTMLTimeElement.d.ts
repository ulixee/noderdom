...
export declare function HTMLTimeElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLTimeElement, TResult2 = never>(onfulfilled?: ((value: IHTMLTimeElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLTimeElementPropertyKeys: string[];
export declare const HTMLTimeElementConstantKeys: string[];
