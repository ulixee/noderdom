...
export declare function HTMLObjectElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLObjectElement, TResult2 = never>(onfulfilled?: ((value: IHTMLObjectElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLObjectElementPropertyKeys: string[];
export declare const HTMLObjectElementConstantKeys: string[];
