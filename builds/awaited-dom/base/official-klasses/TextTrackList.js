...
exports.TextTrackListConstantKeys = exports.TextTrackListPropertyKeys = exports.TextTrackListGenerator = exports.awaitedHandler = exports.setState = exports.getState = void 0;
...
function TextTrackListGenerator() {
    return class TextTrackList {
        ...
        [Symbol.for('nodejs.util.inspect.custom')]() {
            return (0, inspectInstanceProperties_1.default)(this, exports.TextTrackListPropertyKeys, exports.TextTrackListConstantKeys);
        }
    };
}
