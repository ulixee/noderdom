...
export declare const awaitedHandler: AwaitedHandler<IHTMLScriptElement>;
export declare const nodeFactory: NodeFactory<IHTMLScriptElement>;
export declare function HTMLScriptElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLScriptElement, TResult2 = never>(onfulfilled?: ((value: IHTMLScriptElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLScriptElementPropertyKeys: string[];
export declare const HTMLScriptElementConstantKeys: string[];
