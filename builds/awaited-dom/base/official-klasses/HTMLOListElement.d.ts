...
export declare const awaitedHandler: AwaitedHandler<IHTMLOListElement>;
export declare const nodeFactory: NodeFactory<IHTMLOListElement>;
export declare function HTMLOListElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly compact: Promise<boolean>;
        readonly reversed: Promise<boolean>;
        readonly start: Promise<number>;
        readonly type: Promise<string>;
        then<TResult1 = IHTMLOListElement, TResult2 = never>(onfulfilled?: ((value: IHTMLOListElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLOListElementPropertyKeys: string[];
export declare const HTMLOListElementConstantKeys: string[];
