...
export declare function HTMLImageElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        decode(): Promise<void>;
        then<TResult1 = IHTMLImageElement, TResult2 = never>(onfulfilled?: ((value: IHTMLImageElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLImageElementPropertyKeys: string[];
export declare const HTMLImageElementConstantKeys: string[];
