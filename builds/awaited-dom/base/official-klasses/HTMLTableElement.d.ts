...
export declare const awaitedHandler: AwaitedHandler<IHTMLTableElement>;
export declare const nodeFactory: NodeFactory<IHTMLTableElement>;
export declare function HTMLTableElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLTableElement, TResult2 = never>(onfulfilled?: ((value: IHTMLTableElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLTableElementPropertyKeys: string[];
export declare const HTMLTableElementConstantKeys: string[];
