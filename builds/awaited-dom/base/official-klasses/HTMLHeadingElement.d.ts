...
export declare const awaitedHandler: AwaitedHandler<IHTMLHeadingElement>;
export declare const nodeFactory: NodeFactory<IHTMLHeadingElement>;
export declare function HTMLHeadingElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly align: Promise<string>;
        then<TResult1 = IHTMLHeadingElement, TResult2 = never>(onfulfilled?: ((value: IHTMLHeadingElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLHeadingElementPropertyKeys: string[];
export declare const HTMLHeadingElementConstantKeys: string[];
