...
export declare function HTMLMeterElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLMeterElement, TResult2 = never>(onfulfilled?: ((value: IHTMLMeterElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLMeterElementPropertyKeys: string[];
export declare const HTMLMeterElementConstantKeys: string[];
