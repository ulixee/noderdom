...
export declare const awaitedHandler: AwaitedHandler<IHTMLPreElement>;
export declare const nodeFactory: NodeFactory<IHTMLPreElement>;
export declare function HTMLPreElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        readonly width: Promise<number>;
        then<TResult1 = IHTMLPreElement, TResult2 = never>(onfulfilled?: ((value: IHTMLPreElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLPreElementPropertyKeys: string[];
export declare const HTMLPreElementConstantKeys: string[];
