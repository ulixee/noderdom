...
export declare const awaitedHandler: AwaitedHandler<IHTMLTableColElement>;
export declare const nodeFactory: NodeFactory<IHTMLTableColElement>;
export declare function HTMLTableColElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLTableColElement, TResult2 = never>(onfulfilled?: ((value: IHTMLTableColElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLTableColElementPropertyKeys: string[];
export declare const HTMLTableColElementConstantKeys: string[];
