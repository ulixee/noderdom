...
export declare const awaitedHandler: AwaitedHandler<IHTMLFrameElement>;
export declare const nodeFactory: NodeFactory<IHTMLFrameElement>;
export declare function HTMLFrameElementGenerator(HTMLElement: Constructable<IHTMLElement>): {
    new (): {
        ...
        then<TResult1 = IHTMLFrameElement, TResult2 = never>(onfulfilled?: ((value: IHTMLFrameElement) => TResult1 | PromiseLike<TResult1>) | null | undefined, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null | undefined): Promise<TResult1 | TResult2>;
...
export declare const HTMLFrameElementPropertyKeys: string[];
export declare const HTMLFrameElementConstantKeys: string[];
