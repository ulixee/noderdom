...
exports.XPathEvaluatorConstantKeys = exports.XPathEvaluatorPropertyKeys = exports.XPathEvaluatorGenerator = exports.awaitedHandler = exports.recordProxy = exports.setState = exports.getState = void 0;
...
function XPathEvaluatorGenerator(XPathEvaluatorBase) {
    return class XPathEvaluator extends XPathEvaluatorBase {
        constructor() {
            super();
            initializeConstantsAndProperties_1.default(this, exports.XPathEvaluatorConstantKeys, exports.XPathEvaluatorPropertyKeys);
        }
    };
}
