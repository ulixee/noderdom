...
export declare function SelectionGenerator(): {
    new (): {
        ...
        collapse(node: INodeIsolate | null, offset?: number | undefined): Promise<void>;
        collapseToEnd(): Promise<void>;
        collapseToStart(): Promise<void>;
        containsNode(node: INodeIsolate, allowPartialContainment?: boolean | undefined): Promise<boolean>;
        deleteFromDocument(): Promise<void>;
        empty(): Promise<void>;
        extend(node: INodeIsolate, offset?: number | undefined): Promise<void>;
        ...
        setPosition(node: INodeIsolate | null, offset?: number | undefined): Promise<void>;
