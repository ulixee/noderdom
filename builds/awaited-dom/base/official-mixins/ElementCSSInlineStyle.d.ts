...
export declare const getState: (instance: IElementCSSInlineStyle) => IElementCSSInlineStyleProperties, setState: (instance: IElementCSSInlineStyle, properties: Partial<IElementCSSInlineStyleProperties>) => void, recordProxy: (proxy: IElementCSSInlineStyle, instance: IElementCSSInlineStyle) => void;
