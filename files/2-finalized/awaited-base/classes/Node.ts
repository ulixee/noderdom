...
import { INode, INodeList, IDocument, IElement } from '../interfaces/dom';
...
export default class Node implements INode {
  ...
  constructor() {
    initializeConstantsAndProperties<Node>(Node, this, NodeConstantKeys, NodePropertyKeys);
  }
...
export interface INodeReadonlyProperties {
...
export interface INodeProperties extends INodeReadonlyProperties {}
