...
import { IAttrIsolate } from '../interfaces/isolates';
import { IElement } from '../interfaces/dom';

export const { getState, setState, setHiddenState, setReadonlyOfAttrIsolate } = StateMachine<
  IAttrIsolate,
  IAttrIsolateProperties,
  IAttrIsolateReadonlyProperties
>('AttrIsolate');
...
export interface IAttrIsolateReadonlyProperties {
...
export interface IAttrIsolateProperties extends IAttrIsolateReadonlyProperties {}
