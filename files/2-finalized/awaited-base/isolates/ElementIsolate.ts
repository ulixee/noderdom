...
import { IElementIsolate } from '../interfaces/isolates';
...
export const { getState, setState, setHiddenState, setReadonlyOfElementIsolate } = StateMachine<
  IElementIsolate,
  IElementIsolateProperties,
  IElementIsolateReadonlyProperties
>('ElementIsolate');
...
export interface IElementIsolateReadonlyProperties {
...
export interface IElementIsolateProperties extends IElementIsolateReadonlyProperties {}
