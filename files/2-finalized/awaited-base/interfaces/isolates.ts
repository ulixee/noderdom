...
import { IElement, IText, IHTMLCollection, IHTMLElement, IDocumentType, IFeaturePolicy, IFontFaceSet, IHTMLHeadElement, IDOMImplementation, ILocation, INodeList, INamedNodeMap, IDOMTokenList, IShadowRoot, IStylePropertyMapReadOnly, IAttr, IDOMRect, IDOMRectList } from './dom';

import { IWindowProxy, IDocumentReadyState, IVisibilityState, IFullscreenOptions, IScrollIntoViewOptions } from './types';
