...
const SuperDocumentBaseClass = SuperDocumentGenerator(DocumentOrShadowRoot, FontFaceSource, NodeIsolate, NonElementParentNode, ParentNode, XPathEvaluatorBase);
