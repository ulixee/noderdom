...
import { IDocumentOrShadowRoot, IFontFaceSource, INonElementParentNode, IParentNode, IXPathEvaluatorBase, IDocumentType, IFeaturePolicy, IHTMLHeadElement, IDOMImplementation, ILocation, IDocumentReadyState, IVisibilityState, IElementCSSInlineStyle, IElementContentEditable, IHTMLOrSVGElement, INonDocumentTypeChildNode, INamedNodeMap, IDOMTokenList, IShadowRoot, IStylePropertyMapReadOnly, IAttr, IDOMRect, IDOMRectList, IFullscreenOptions, IScrollIntoViewOptions, IGetRootNodeOptions } from './official';
...
export interface ISuperDocument extends IDocumentOrShadowRoot, IFontFaceSource, INodeIsolate, INonElementParentNode, IParentNode, IXPathEvaluatorBase {
