...
export default class TsTypesExtractor {
  ...
  public run() {
    ...
    const referencedTypes = TsExtractor.locateReferences(references, { ignore: defines });
    const importsCodeModule = TsExtractor.extractImportCodeModule(referencedTypes, './dom');
